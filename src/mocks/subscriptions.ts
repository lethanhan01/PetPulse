...
export const MOCK_SUBSCRIPTIONS: Subscription[] = [
  ...
  { id: "SUB-02", name: "Premium", price: "99.000đ", period: "mỗi tháng", features: ["Không giới hạn thú cưng", "AI Symptom Checker không giới hạn", "Health Score nâng cao", "Thống kê & báo cáo chi tiết", "Ưu tiên hỗ trợ 24/7", "Xuất hồ sơ PDF"], missing: [], subscribers: PREM_COUNT, active: true, accent: true, tagline: "Mở khóa toàn bộ sức mạnh của PetPulse" },
  { id: "SUB-03", name: "Premium Năm", price: "990.000đ", period: "năm", features: ["Toàn bộ Premium", "Ưu đãi 2 tháng", "Báo cáo năm"], missing: [], subscribers: PREM_YEAR_COUNT, active: true },
];
