...
const accountRows: Array<[string, string, "user" | "admin", "Free" | "Premium", "Active" | "Suspended"]> = [
  ["Nguyễn Văn An", "an@example.com", "user", "Premium", "Active"], ["Quản trị viên", "admin@petpulse.vn", "admin", "Premium", "Active"],
  ["Trần Thu Hà", "ha@example.com", "user", "Free", "Active"], ["Lê Minh Quân", "quan@example.com", "user", "Premium", "Active"],
  ["Phạm Ngọc Linh", "linh@example.com", "user", "Free", "Suspended"], ["Đỗ Hải Yến", "yen@example.com", "user", "Premium", "Active"],
  ...
  ["Đặng Quốc Bảo", "bao.dang@example.com", "user", "Free", "Active"], ["Võ Khánh Linh", "khanhlinh@example.com", "user", "Premium", "Active"],
  ["Lý Gia Hân", "gihan@example.com", "user", "Free", "Active"], ["Phan Nhật Hào", "nhathao@example.com", "user", "Premium", "Active"],
  ["Dương Tú Uyên", "tuyen.duong@example.com", "user", "Free", "Active"], ["Trương Minh Khang", "khang.truong@example.com", "user", "Premium", "Suspended"],
  ["Lâm Phương Thảo", "thao.lam@example.com", "user", "Free", "Active"], ["Cao Quốc Việt", "viet.cao@example.com", "user", "Premium", "Active"],
  ["Đinh Bảo Trâm", "tram.dinh@example.com", "user", "Free", "Active"], ["Mai Đức Long", "long.mai@example.com", "user", "Premium", "Active"],
  ["Nguyễn Khánh Vy", "vy.nguyen@example.com", "user", "Free", "Active"], ["Trần Gia Bảo", "giabao.tran@example.com", "user", "Premium", "Active"],
  ["Lê Thu Trang", "trang.le@example.com", "user", "Free", "Active"], ["Phạm Hải Đăng", "dang.pham@example.com", "user", "Premium", "Active"],
  ...
  ["Hoàng Bích Ngọc", "ngoc.hoang@example.com", "user", "Free", "Suspended"], ["Võ Trọng Nhân", "nhan.vo@example.com", "user", "Premium", "Active"],
  ...
  ["Lâm Tuyết Nhi", "nhi.lam@example.com", "user", "Free", "Active"], ["Cao Đức Thịnh", "thinh.cao@example.com", "user", "Premium", "Active"],
  ...
  ["Lê Bảo Ngân", "baongan.le@example.com", "user", "Free", "Active"], ["Phạm Anh Khoa", "khoa.pham@example.com", "user", "Premium", "Suspended"],
  ...
  ["Hoàng Tuệ Nhi", "tuenhi.hoang@example.com", "user", "Free", "Active"], ["Võ Minh Đức", "minhduc.vo@example.com", "user", "Premium", "Active"],
